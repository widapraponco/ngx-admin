...
@Component({
  selector: 'ngx-swimlane-datatable',
  templateUrl: './swimlane-datatable.component.html',
  styleUrls: ['./swimlane-datatable.component.scss'],
})
export class SwimlaneDatatableComponent {
